...
class File_Operation:
    ...
    def save_model(self, model, filename):
        ...
        try:
            path = os.path.join(self.model_directory, filename)  # create separated directory for each
            ...
            self.logger_object.log(self.file_object, 'Model File' + filename + 'saved. Exited the save model of the '
    ...
    def load_model(self, filename):
        ...
        try:
            ...
            self.logger_object.log(self.file_object,
                                   'Exception occurred in load_model method of the File_Operation class Exception '
                                   'message:  ' + str(e))
            self.logger_object.log(self.file_object,
